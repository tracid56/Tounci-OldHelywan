ALTER TABLE `users`
	...
	ADD COLUMN `org` varchar(50) NULL DEFAULT 'narek' AFTER `job_grade`,
...
INSERT INTO `job_grades` VALUES (1,'unemployed',0,'unemployed','RSA',200,'{}','{}');
...
INSERT INTO `org_gradeorg` VALUES (1,'narek',0,'narek','RSA',200,'{}','{}');
...
INSERT INTO `org` VALUES ('narek','Chômeur');
