...
AddEventHandler('esx:playerLoaded', function(xPlayer)
	...
	if Config.EnableHud then
        ...
        local accountTpl = '<div><img src="img/accounts/cash.png">&nbsp;{{money}}&nbsp;</div>'

        ESX.UI.HUD.RegisterElement('moneyDisplay', -1, 0, accountTpl, {
            money = 0
        })
        ...
        Citizen.CreateThread(function()
            ...
            while true do
                ...
                Citizen.Wait(2000)
                ESX.UI.HUD.UpdateElement('moneyDisplay', {
