...
-- Events
-- RegisterNetEvent("ped_wel_police:createPED")
-- AddEventHandler("ped_wel_police:createPED", function()
	-- create_ped_wel_police()
-- end)

-- Fonction principale
-- function create_ped_wel_police()
	-- Spawn NPC
	  ...
	  while true do
		...
		if (not generalLoaded) then
		  ...
		  for i=1, #policestation do
			...
			policestation[i].id = CreatePed(2, policestation[i].modelHash, policestation[i].x, policestation[i].y, policestation[i].z, policestation[i].heading, false, false)
