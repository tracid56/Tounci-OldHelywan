  ...
  while true do
	...
	if (not generalLoaded) then
	  ...
	  for i=1, #FleecaPed do
        ...
        FleecaPed[i].id = CreatePed(2, FleecaPed[i].modelHash, FleecaPed[i].x, FleecaPed[i].y, FleecaPed[i].z, FleecaPed[i].heading, false, true)
