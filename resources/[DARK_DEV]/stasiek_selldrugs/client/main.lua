...
AddEventHandler('sellingdrugs', function()
	secondsRemaining = math.random(Config.TimeToSellMin, Config.TimeToSellMax) + 1
	selling = true
end)
...
local blipTime = 120 --in second --default 25
local notifyTime = 6000 --default 3000
        ...
        if pedIsTryingToSellDrugs then
			...
			elseif PlayerData.job ~= nil and PlayerData.job.name == 'police' and showcopsmisbehave then
				ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
					local sex = nil
					if skin.sex == 0 then
						sex = "男性" --male/change it to your language
					else
						sex = "女性" --female/change it to your language
					end
