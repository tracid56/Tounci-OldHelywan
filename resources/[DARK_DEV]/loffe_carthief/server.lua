...
AddEventHandler( "playerConnecting", function(name)
	...
	if not result then
		...
		--print('Player with steam name ' .. name .. ' lades in a "carthief" database, ' .. name .. '\'s hex code is:' .. identifier)
		--print('/////////////////////////////////////////////////////////////////////////')
    end
end)
...
AddEventHandler('loffe_carthief:questFinished', function()
	...
	local payment = math.random(Config.MinPayment, Config.MaxPayment) -- what you get to do the job, 50-75 thousand.
