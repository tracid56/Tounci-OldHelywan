...
Citizen.CreateThread(function()
    if Config.DrawBlips then
        ...
        addBlip(325.79061889648, -2050.5573730469, 20.936388015747 - 1.0001, _U('biker_clubhouse'), 310)
        addBlip(85.769508361816, -1959.3798828125, 21.121688842773 - 1.0001, _U('biker_clubhouse'), 492)
...
Citizen.CreateThread(function()
    while true do
        ...
        -- motero check
        DrawMarker(1, 325.79061889648, -2050.5573730469, 20.936388015747 - 1.0001, 0, 0, 0, 0, 0, 0, 1.0, 1.0, 1.0, 13, 232, 255, 155, 0, 0, 2, 0, 0, 0, 0)
        if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, 325.79061889648, -2050.5573730469, 20.936388015747, true) <= 3.0 then
            if IsControlPressed(0, 51) then
        ...
        -- motero2 check
        DrawMarker(1, 85.769508361816, -1959.3798828125, 21.121688842773 - 1.0001, 0, 0, 0, 0, 0, 0, 1.0, 1.0, 1.0, 13, 232, 255, 155, 0, 0, 2, 0, 0, 0, 0)
        if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, 1110.53, -3167.13, -37.52, true) <= 3.0 then
            if IsControlPressed(0, 51) then
        ...
        -- doomsday check
        DrawMarker(1, -583.097290, 228.080215, 78.417747 - 119.125, 0, 0, 0, 0, 0, 0, 1.0, 1.0, 1.0, 13, 232, 255, 155, 0, 0, 2, 0, 0, 0, 0)
        if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, -583.097290, 228.080215, 78.417747, true) <= 3.0 then
            if IsControlPressed(0, 51) then
        ...
        if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, 996.88189697266, -3157.9697265625, -38.907146453858, true) <= 2.0 then
            ...
            if IsControlPressed(0, 51) then
                ...
                SetEntityCoords(GetPlayerPed(-1), 325.79061889648, -2050.5573730469, 20.936388015747, 125.059)
                Citizen.Wait(1000)
                DoScreenFadeIn(1000)
            end
        end
        ...
        -- motero2 exit 1
        if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, 1120.97, -3152.68, -37.06, -37.52, true) <= 2.0 then
            -- TriggerEvent("fs_freemode:displayHelp", i18n.translate("exit_warehouse"))
            ESX.ShowHelpNotification(_U('press_to_exit'))
            if IsControlPressed(0, 51) then
                DoScreenFadeOut(1000)
                ...
                SetEntityCoords(GetPlayerPed(-1), 1110.53,  -3167.13, -37.52, 125.059)
                Citizen.Wait(1000)
                DoScreenFadeIn(1000)
            end
        end
        ...
        if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, 1110.53,  -3167.13, -37.52, 125.059, true) <= 2.5 then
            -- TriggerEvent("fs_freemode:displayHelp", i18n.translate("exit_warehouse"))
            ESX.ShowHelpNotification(_U('press_to_exit'))
            if IsControlPressed(0, 51) then
                DoScreenFadeOut(1000)
                ...
                SetEntityCoords(GetPlayerPed(-1), 85.769508361816, -1959.3798828125, 21.121688842773, 140.62)
                Citizen.Wait(1000)
                DoScreenFadeIn(1000)
            end
        end
