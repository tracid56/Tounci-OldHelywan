...
function OpenVehicleMenu() -- Menu location véhicules
    ...
    local elements = {
        {label = 'Seashark', value = 'Seashark', price = 1500},
		{label = 'Seashark2', value = 'Seashark3', price = 1500}
    }
    ...
    ESX.UI.Menu.Open(
        ...
        {
            title = 'Location de Jetski', -- Titre du menu
            elements = elements
        },
        function(data, menu)
            for i=1, #elements, 1 do
                ...
                TriggerServerEvent('esx_location3:Buy', price) -- Event permetant de faire payer le joueur
                break
            end
            menu.close()
    end,
    function(data, menu)
        ...
        CurrentActionMsg  = '~INPUT_CONTEXT~ Location de Jetski'
        CurrentActionData = {}
    end
    )
end

AddEventHandler('esx_location3:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_location3:hasExitedMarker', function(zone)
    CurrentAction = nil
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
			...
			TriggerEvent('esx_location3:hasEnteredMarker', currentZone)
		end
		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('esx_location3:hasExitedMarker', LastZone)
		end
...
Citizen.CreateThread(function()	
	...
	AddTextComponentString("Location de Jetski")
