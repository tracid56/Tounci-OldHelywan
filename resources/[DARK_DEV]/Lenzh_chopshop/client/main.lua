...
Citizen.CreateThread(function()
	...
	function Notification(message)
		...
		SetNotificationMessage("CHAR_MECHANIC", "CHAR_MECHANIC", true, 1, "Stanley", "~g~Merci~s~, voila ton argent"); -- Notif
		DrawNotification(false, true);
end

RegisterNetEvent('fantasia_vol:showNotification')
AddEventHandler('fantasia_vol:showNotification', function(notify)
		Notification(notify)
end)
...
function OpenShop()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'car_shop', {
		...
		TriggerEvent("fantasia_vol:showNotification", _source, "")
