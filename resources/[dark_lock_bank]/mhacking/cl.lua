			...
			if VaultDoor ~= nil and VaultDoor ~= 0 then
				...
				if not CodeEnteredCorrect and CodeNeeded then
					...
					if GetIsControlJustReleased(51) and (UpdateOnscreenKeyboard() ~= 0)then
							...
							TriggerEvent("mhacking:start",7,90,mycb) --This line is the difficulty and tells it to start. First number is how long the blocks will be the second is how much time they have is.
