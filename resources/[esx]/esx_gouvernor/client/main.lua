			...
			if data.current.value == 'vehicle_list' then
				...
				if Config.EnableSocietyOwnedVehicles then
						...
						local elements = {
							...
							{label = 'Hélico de luxe', value = 'volatus'}
						}
...
function OpenGetStocksMenu()
  ESX.TriggerServerCallback('esx_gouverneur:getStockItems', function(items)
    local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              menu2.close()
              menu.close()
              TriggerServerEvent('esx_gouverneur:getStockItem', itemName, count)
...
ESX.TriggerServerCallback('esx_gouverneur:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              menu2.close()
              menu.close()
              TriggerServerEvent('esx_gouverneur:putStockItems', itemName, count)
