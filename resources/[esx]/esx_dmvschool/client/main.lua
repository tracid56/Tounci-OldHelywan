...
function StartTheoryTest()
  ESX.TriggerServerCallback('esx_dmvschool:pay', function(payed)
    if payed == true then
      CurrentTest = 'theory'
    ...
    -- else
    --   ESX.ShowNotification(_U('yourpoor'))
    end
...
function OpenDMVSchoolMenu()
  ...
  if not ownedLicenses['dmv'] then
    table.insert(elements, {label = _U('theory_test') .. '<span style="color:green;float:right;">' .. Config.Prices['dmv'] .. ' $</span>', value = 'theory_test'})
  end

  if ownedLicenses['dmv'] then

    if not ownedLicenses['drive'] then
      table.insert(elements, {label = _U('road_test_car') .. ' <span style="color:green;float:right;">' .. Config.Prices['drive'] .. ' $</span>', value = 'drive_test', type = 'drive'})
    end

    if not ownedLicenses['drive_bike'] then
      table.insert(elements, {label = _U('road_test_bike') .. ' <span style="color:green;float:right;">' .. Config.Prices['drive_bike'] .. ' $</span>', value = 'drive_test', type = 'drive_bike'})
    end

    if not ownedLicenses['drive_truck'] then
      table.insert(elements, {label = _U('road_test_truck') .. ' <span style="color:green;float:right;">' .. Config.Prices['drive_truck'] .. ' $</span>', value = 'drive_test', type = 'drive_truck'})
    end
