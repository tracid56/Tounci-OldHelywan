...
Config.Strings = {
	...
	EToRefuel = "Appuyez ~g~E ~w~pour faire le plein de véhicule",
	JerryCanEmpty = "jerrycan est vide",
	FullTank = "Réservoir est plein",
	PurchaseJerryCan = "Appuyez ~g~E ~w~pour acheter un jerrycan pour ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyez ~g~E ~w~pour annuler le ravitaillement",
	CancelFuelingJerryCan = "Appuyez ~g~E ~w~pour annuler le ravitaillement",
	NotEnoughCash = "Pas assez d'argent",
	RefillJerryCan = "Appuyez ~g~E ~w~ pour remplir le jerrycan pour ",
	NotEnoughCashJerryCan = "Pas assez d’argent pour remplir le jerrican",
	JerryCanFull = "jerrican est plein",
	TotalCost = "Coût",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Appuyez ~g~E ~w~pour prendre un jerrycan"
	Config.Strings.RefillJerryCan = "Appuyez ~g~E ~w~ pour remplir le jerrycan"
end
