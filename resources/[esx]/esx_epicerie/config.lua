...
Config.PriceResell                = {eau = 40, pain = 50}
Config.Locale                     = 'fr'
...
Config.AuthorizedVehicles = {
	...
	{ name = 'youga',  label = 'Véhicule de vente' },
}

Config.Blips = {
    
    Blip = {
      Pos     = { x = 45.892593, y = -1748.911254, z =  29.615777 },
      Sprite  = 52,
      Display = 4,
      Scale   = 0.9,
      Colour  = 48,
...
Config.Zones = {
    ...
    Cloakrooms = {
        Pos   = { x = 47.905345, y = -1784.553833, z = 28.588146 },
    ...
    Vaults = {
        Pos   = { x = 56.689716, y = -1752.888305, z = 28.534105 },
    ...
    Vehicles = {
        Pos          = { x = 24.167152, y = -1771.709594, z = 28.715497 },
        SpawnPoint   = { x = 22.202613, y = -1774.239013, z = 28.713848 },
    ...
    VehicleDeleters = {
        Pos   = { x = 20.215564, y = -1776.649414, z = 28.714233 },
...
--[[
    ...
    BossActions = {
        Pos   = { x = 52.70809173, y = -1753.057373, z = 28.514230 },
        Size  = { x = 1.5, y = 1.5, z = 1.0 },
        Color = { r = 0, g = 100, b = 0 },
        Type  = 1,
    },
