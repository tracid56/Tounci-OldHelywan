Locales['fr'] = {   
  ...
  ['craft2'] = 'Suite de la Transformation',
  ['not_enough_ble'] = "Vous n'avez pas de blé",
  ['not_enough_carotte'] = "Vous n'avez pas de carotte",
  ['not_enough_farine'] = "Vous n'avez pas de Farine",
  ['fabriquation_du_pain'] = "Création du pain",
  ['fabriquation_du_carottevend'] = "Création des Carotte à vendre",
  ['not_enough_de_carotte_lave'] = "Vous n'avez pas de carotte lavé",
  ['no_bread_sale'] = "Vous n'avez pas de Pain",
  ['harvest2_menu'] = 'Récolte Blé',
  ['Harvest'] = 'Récolte Blé',
}
