...
TriggerEvent('esx_organisation:registerOrganisation', 'thelostmc', 'TheLostMC', 'organisation_thelostmc', 'organisation_thelostmc', 'organisation_thelostmc', {type = 'public'})
...
AddEventHandler('esx_thelostmcjob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'organisation_thelostmc', function(inventory)
