  ...
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'gang' then
      ...
      for k,v in pairs(Config.GangStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.org ~= nil and PlayerData.org.name == 'gang' and PlayerData.org.gradeorg_name == 'boss' then
