Locales['en'] = {
  ...
  ['vehicle_out'] = 'il y a déjà un véhicule sur',
  ['vehicle_spawner'] = 'presse ~INPUT_CONTEXT~ pour faire apparaître un véhicule',
  ['store_vehicle'] = 'presse ~INPUT_CONTEXT~ ranger le véhicule',
