  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_mafiaorg:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableOrganisationOwnedVehicles then
    ...
    if Config.EnablePlayerManagement and PlayerData.org ~= nil and
      (PlayerData.org.grade_name == 'boss') then
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_mafiaorg:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_mafiaorg:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_mafiaorg:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_mafiaorg:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_mafiaorg:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_mafiaorg:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_mafiaorg:getFineList', function(fines)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'Organisation_mafia', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_mafiaorg:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_mafiaorg:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mafiaorg:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_mafiaorg:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  ESX.TriggerServerCallback('esx_mafiaorg:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mafiaorg:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_mafiaorg:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mafiaorg:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_mafiaorg:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mafiaorg:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_mafiaorg:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_mafiaorg:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_mafiaorg:hasEnteredEntityZone', function(entity)
...
AddEventHandler('esx_mafiaorg:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_mafiaorg:handcuff')
AddEventHandler('esx_mafiaorg:handcuff', function()
...
RegisterNetEvent('esx_mafiaorg:drag')
AddEventHandler('esx_mafiaorg:drag', function(cop)
...
RegisterNetEvent('esx_mafiaorg:putInVehicle')
AddEventHandler('esx_mafiaorg:putInVehicle', function()
...
RegisterNetEvent('esx_mafiaorg:OutVehicle')
AddEventHandler('esx_mafiaorg:OutVehicle', function(t)
  ...
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'mafia' then
      ...
      for k,v in pairs(Config.MafiaStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.org ~= nil and PlayerData.org.name == 'mafia' and PlayerData.org.grade_name == 'boss' then
  ...
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'mafia' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_mafiaorg:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_mafiaorg:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_mafiaorg:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_mafiaorg:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
