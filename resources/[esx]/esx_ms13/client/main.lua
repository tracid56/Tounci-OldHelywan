    ...
    ESX.TriggerServerCallback('esx_organisation:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_organisation:removeVehicleFromGarage', 'ms13', vehicleProps)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'organisation_ms13', _U('fine_total') .. label, amount)
        else
...
AddEventHandler('esx_ms13job:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.org ~= nil and PlayerData.org.name == 'ms13' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'ms13' then
      ...
      for k,v in pairs(Config.GangStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.org ~= nil and PlayerData.org.name == 'ms13' and PlayerData.org.gradeorg_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.org ~= nil and PlayerData.org.name == 'ms13' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableOrganisationOwnedVehicles then
            ...
            TriggerServerEvent('esx_organisation:putVehicleInGarage', 'ms13', vehicleProps)
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_organisation:openBossMenu', 'ms13', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.org ~= nil and PlayerData.org.name == 'ms13' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'ms13_actions') and (GetGameTimer() - GUI.Time) > 150 then
     Openms13ActionsMenu()
     GUI.Time = GetGameTimer()
    end
