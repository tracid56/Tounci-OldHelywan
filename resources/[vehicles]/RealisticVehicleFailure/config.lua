...
repairCfg = {
	...
	fixMessages = {
		"Vous remettez le bouchon d'huile dans",
		"Vous avez arrêté la fuite d'huile avec du chewing-gum",
		"Vous avez réparé le tube d'huile avec du ruban adhésif",
		"Vous avez serré la vis du carter d'huile et arrêté les gouttes",
		"Vous avez lancé le moteur et il est revenu comme par magie",
		"Vous avez enlevé de la rouille du tube d'allumage",
		"Vous avez crié après votre véhicule et cela a eu un effet"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Vous avez vérifié le bouchon d'huile. C'est toujours là",
		"Vous avez regardé votre moteur, il semblait bien",
		"Vous vous êtes assuré que le ruban adhésif retenait toujours le moteur",
		"Vous avez augmenté le volume de la radio. Il a juste noyé les bruits étranges du moteur",
		"Vous avez ajouté un antirouille au tube à étincelles. Ça n'a fait aucune différence",
		"Ne réparez jamais quelque chose qui n'est pas cassé, ont-ils dit. Tu n'as pas écouté. Au moins ça n'a pas empiré"
	},
	noFixMessageCount = 6
}
