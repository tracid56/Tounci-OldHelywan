...
AddEventHandler('esx:playerLoaded', function(xPlayer) 
	...
	SendNUIMessage({action = "setValue", key = "org", value = data.org.label .. " - " .. data.org.gradeorg_label})
...
AddEventHandler('esx:setorg', function(org)
	SendNUIMessage({action = "setValue", key = "org", value = org.label .. " - " .. org.grade_label})
end)
